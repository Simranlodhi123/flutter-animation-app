import 'dart:math';
import 'package:animation_app/animated.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(icon: Icon(Icons.vibration),onPressed: (){print('pressed');}),
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        OutlineButton(
          ...
          textColor: Colors.black,
          padding: const EdgeInsets.all(12.0),
          child: Text('Start Vibration Icon Animation'),
          onPressed: () {
        ...
        Expanded(
          child: Padding(
            ...
            child: OutlineButton(
              ...
              child: Text('Stop Vibration Icon'),
              onPressed: () {
